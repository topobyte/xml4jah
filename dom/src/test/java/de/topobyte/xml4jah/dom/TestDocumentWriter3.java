...
public class TestDocumentWriter3
{
	...
	{
		test("adams/v3/source.xml", Arrays.asList("year", "wikidata", "title"));
	}
			...
			throws IOException, ParserConfigurationException, SAXException
	{
		...
		Util.test("adams/v3/no-ending-newline.xml", document(), config);
	}
	...
	private Document document()
			throws IOException, SAXException, ParserConfigurationException
	{
		return Util.document("adams/v3/source.xml");
	}
